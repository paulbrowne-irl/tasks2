...
*Additional Prompts - add GUI to exiting project*
Generate a new specification based on the specification in spec2-gui.md and spec1.md. Where there is conflict between the two specifications, the specification in spec2-gui.md takes precedence. Compare the existing project to the newly generated specification,and implement the changes to the existing project.Follow the requirements exactly as specified.
